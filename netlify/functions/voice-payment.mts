...
export default async (req: Request, context: Context) => {
  ...
  const officeBody = `DCA deposit received: ${payment.row.customerName}, ${money(remaining)}, ${payment.row.serviceType}, job #${payment.row.jobId}, source ${payment.row.source || "website"}. Please confirm the appointment time with the customer.`;
  ...
  return Response.json({
    ...
    amountCents: remaining,
    serviceType: payment.row.serviceType,
    message: "Thank you. Your deposit was received. The DCA office will contact you to confirm your appointment time."
  });
};
